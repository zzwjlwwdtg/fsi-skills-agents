...
Decision packet:
{
  "timestamp_local": "2026-06-19T01:12:13",
  "ticker": "US.DRAM",
  "window": "midday",
  "market": {
    "ticker": "DRAM",
  ...
  "rule_decision": {
    ...
    "confluence": {
      "bull_signals": [
        "价格站上MA20(价格77.04 > MA20=64.99)",
        "均线多排(MA20=64.99 > MA50=51.77)",
        "当日暴涨(+10.1%，>+5%)  ⚠超买风险"
      ],
      "bear_signals": [
        "CCI超买(CCI=159，中性区间-100~+100，当前高于+100)"
      ],
      "bull_count": 3,
      "bear_count": 1,
      "net": 2,
