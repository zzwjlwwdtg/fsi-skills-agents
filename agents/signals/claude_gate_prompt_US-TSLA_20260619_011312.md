...
Decision packet:
{
  "timestamp_local": "2026-06-19T01:13:12",
  "ticker": "US.TSLA",
  "window": "midday",
  "market": {
    "ticker": "TSLA",
    ...
    "dist_from_high": -21.36,
    "trend": "down",
    "ma_stack": "bull",
    "rsi_zone": "oversold",
    "vol_zone": "shrink",
    "pct_chg_zone": "mild_drop",
    "pre_price": 397.86,
    "pre_pct": 0.373,
    "pre_volume": 373981.0,
    "pre_date": "2026-06-18",
    "pre_label": "今日盘前(已结束)",
    "after_price": 397.6698,
    "after_pct": 0.325,
    "after_volume": 2475124.0,
    "after_date": "2026-06-17",
    "after_label": "昨日盘后(已结束)",
    "overnight_price": 399.22,
    "overnight_pct": 0.716,
    "overnight_volume": 146418.0,
    "overnight_date": "2026-06-17",
    "overnight_label": "昨夜夜盘(已结束)",
    "now_et": "2026-06-18 12:13 ET",
    "prev_session": {
      "date": "2026-06-16",
      "open": 404.11,
      "close": 404.66,
  ...
  "rule_decision": {
    ...
    "confluence": {
      "bull_signals": [
        "均线多排(MA20=414.33 > MA50=401.26)",
        "RSI超卖(RSI=34，正常区间40-60，<35为超卖)",
        "CCI超卖(CCI=-109，中性区间-100~+100，当前低于-100)",
        "CCI极度超卖(近3日下穿-100，当前=-109)"
      ],
      "bear_signals": [
        "价格跌破MA20(价格392.30 < MA20=414.33)",
        "当日小跌(-1.0%，<-1%)"
      ],
      "bull_count": 4,
      "bear_count": 2,
    ...
    "h1_context": "最新K线@17:00  趋势:向下  RSI:35.9",
