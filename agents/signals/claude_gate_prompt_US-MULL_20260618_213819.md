...
Decision packet:
{
  "timestamp_local": "2026-06-18T21:38:19",
  "ticker": "US.MULL",
  "window": "pre-market",
  "market": {
    "ticker": "MULL",
  ...
  "rule_decision": {
    ...
    "confluence": {
      "bull_signals": [
        "价格站上MA20(价格802.60 > MA20=687.79)",
        "均线多排(MA20=687.79 > MA50=445.93)",
        "当日上涨(+4.1%，>+2%)",
        "[2026-06-18 今日盘前(进行中)] 涨+10.38%  → 开盘大概率跳空高开"
      ],
      "bear_signals": [
        "CCI进入超买(近3日上穿+100，当前=70)"
      ],
      "bull_count": 4,
      "bear_count": 1,
      "net": 3,
