...
Decision packet:
{
  "timestamp_local": "2026-06-18T23:09:56",
  "ticker": "US.SOXL",
  "window": "post-open",
  "market": {
    "ticker": "SOXL",
  ...
  "rule_decision": {
    ...
    "confluence": {
      "bull_signals": [
        "价格站上MA20(价格272.95 > MA20=220.19)",
        "均线多排(MA20=220.19 > MA50=161.52)",
        "均线金叉(MA5上穿MA20，近3日)",
        "当日暴涨(+16.7%，>+5%)  ⚠超买风险"
      ],
      "bear_signals": [
        "CCI超买(CCI=134，中性区间-100~+100，当前高于+100)",
        "CCI进入超买(近3日上穿+100，当前=134)"
      ],
      "bull_count": 4,
      "bear_count": 2,
      "net": 2,
