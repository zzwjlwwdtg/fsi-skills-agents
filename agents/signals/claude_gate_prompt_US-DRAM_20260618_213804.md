...
Decision packet:
{
  "timestamp_local": "2026-06-18T21:38:04",
  "ticker": "US.DRAM",
  "window": "pre-market",
  "market": {
    "ticker": "DRAM",
    ...
    "after_price": 72.35,
    "after_pct": 3.431,
    "after_volume": 1968227.0,
    "after_date": "2026-06-17",
    "after_label": "昨日盘后(已结束)",
    "overnight_price": 74.36,
    "overnight_pct": 6.304,
    "overnight_volume": 1564303.0,
    "overnight_date": "2026-06-17",
    "overnight_label": "昨夜夜盘(已结束)",
    "now_et": "2026-06-18 08:38 ET",
    "prev_session": {
      "date": "2026-06-17",
      "open": 71.75,
      "close": 69.95,
    ...
    "prev_pct": -2.51,
    "today_session": null,
    "today_not_yet_opened": "2026-06-18 今日尚未开盘（距 9:30 ET 还有 0h52m）",
    "ma_cross": "none",
    "rsi_cross": "none",
    "cci_cross": "none",
    "bb_pct": 0.787,
  ...
  "rule_decision": {
    ...
    "confluence": {
      "bull_signals": [
        "价格站上MA20(价格69.95 > MA20=63.50)",
        "均线多排(MA20=63.50 > MA50=50.74)",
        "当日上涨(+2.7%，>+2%)",
        "[2026-06-18 今日盘前(进行中)] 涨+6.74%  → 开盘大概率跳空高开"
      ],
      "bear_signals": [],
      "bull_count": 4,
      "bear_count": 0,
    ...
    "h1_context": "最新K线@17:00  趋势:向下  RSI:46.4",
    "m15_context": "[最新15m K线@2026-06-18 06:00:00] 短线信号弱(信号数 1，方向不明): RSI极度超买(15m RSI=82)",
    "m15_direction": "mixed"
  }
}
