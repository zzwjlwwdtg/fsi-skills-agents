...
Decision packet:
{
  "timestamp_local": "2026-06-19T23:16:20",
  "ticker": "US.TQQQ",
  "window": "post-open",
  "market": {
    "ticker": "TQQQ",
    ...
    "pre_price": 81.99,
    "pre_pct": 5.738,
    "pre_volume": 5851882.0,
    "pre_date": "2026-06-19",
    "pre_label": "今日盘前(已结束)",
    "after_price": 82.98,
    "after_pct": 0.132,
    "after_volume": 1782006.0,
  ...
  "rule_decision": {
    ...
    "confluence": {
      "bull_signals": [
        "价格站上MA20(价格82.87 > MA20=80.07)",
        "均线多排(MA20=80.07 > MA50=70.32)",
        "均线金叉(MA5上穿MA20，近3日)",
        "当日暴涨(+6.9%，>+5%)  ⚠超买风险"
      ],
      "bear_signals": [],
    ...
    "h1_context": "最新K线@17:00  趋势:向下  RSI:33.3  近期死叉",
    "m15_context": "[最新15m K线@2026-06-18 06:00:00] 短线信号弱(信号数 1，方向不明): RSI极度超买(15m RSI=77)",
    "m15_direction": "mixed"
  }
}
