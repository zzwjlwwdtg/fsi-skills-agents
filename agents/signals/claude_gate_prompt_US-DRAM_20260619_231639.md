...
Decision packet:
{
  "timestamp_local": "2026-06-19T23:16:39",
  "ticker": "US.DRAM",
  "window": "post-open",
  "market": {
    "ticker": "DRAM",
    ...
    "pre_price": 75.39,
    "pre_pct": 7.776,
    "pre_volume": 3272288.0,
    "pre_date": "2026-06-19",
    "pre_label": "今日盘前(已结束)",
    "after_price": 78.1485,
    "after_pct": 1.875,
    "after_volume": 2708348.0,
  ...
  "rule_decision": {
    ...
    "confluence": {
      "bull_signals": [
        "价格站上MA20(价格76.71 > MA20=64.95)",
        "均线多排(MA20=64.95 > MA50=51.76)",
        "当日暴涨(+9.7%，>+5%)  ⚠超买风险"
      ],
      "bear_signals": [
        "CCI超买(CCI=156，中性区间-100~+100，当前高于+100)"
      ],
      "bull_count": 3,
      "bear_count": 1,
      "net": 2,
    ...
    "h1_context": "最新K线@17:00  趋势:向下  RSI:38.4  近期死叉",
    "m15_context": "[最新15m K线@2026-06-18 06:00:00] 短线信号弱(信号数 1，方向不明): RSI极度超买(15m RSI=81)",
    "m15_direction": "mixed"
  }
}
