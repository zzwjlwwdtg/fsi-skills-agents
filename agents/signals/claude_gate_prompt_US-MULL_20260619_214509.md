...
Decision packet:
{
  "timestamp_local": "2026-06-19T21:45:09",
  "ticker": "US.MULL",
  "window": "pre-market",
  "market": {
    "ticker": "MULL",
    ...
    "prev_pct": -14.33,
    "today_session": null,
    "today_not_yet_opened": "2026-06-19 今日尚未开盘（距 9:30 ET 还有 0h45m）",
    "ma_cross": "none",
    "rsi_cross": "none",
    "cci_cross": "up_100",
    "bb_pct": 0.884,
  ...
  "rule_decision": {
    ...
    "confluence": {
      "bull_signals": [
        "价格站上MA20(价格940.77 > MA20=713.00)",
        "均线多排(MA20=713.00 > MA50=461.48)",
        "当日暴涨(+17.2%，>+5%)  ⚠超买风险",
        "[2026-06-19 今日盘前(进行中)] 涨+12.88%  → 开盘大概率跳空高开"
      ],
      "bear_signals": [
        "CCI超买(CCI=135，中性区间-100~+100，当前高于+100)",
        "CCI进入超买(近3日上穿+100，当前=135)"
      ],
      "bull_count": 4,
      "bear_count": 2,
      "net": 2,
    ...
    "h1_context": "最新K线@17:00  趋势:向下  RSI:38.5  近期死叉",
